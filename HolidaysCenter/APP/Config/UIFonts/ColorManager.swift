...
extension UIColor {
    ...
    public static var AppImgColor : UIColor {
        
        get {
            return UIColor(named: "AppImgColor")!
        }
    }
    
    public static var BtnTitleColor : UIColor {
        
        get {
            return UIColor(named: "BtnTitleColor")!
        }
    }
    ...
    public static var AppBoldColor : UIColor {
