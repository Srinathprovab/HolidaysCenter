...
class EditProfileVC: BaseTableVC, ProfileUpdateViewModelDelegate {
    ...
    func appendLoginTvcells() {
        ...
        tablerow.append(TableRow(title:"Date Of Birth*",
                                 subTitle: convertDateFormat(inputDate: date_of_birth, f1: "yyyy-MM-dd", f2: "dd-MM-yyyy"),
                                 key: "dob",
                                 text:"3",
                                 tempText: "dob",
                                 cellType:.TextfieldTVCell))
        
        tablerow.append(TableRow(title:"Mobile Number",
                                 subTitle: phone,
                                 key: "mobile",
                                 text:"4",
                                 buttonTitle: "\(country_code)",
                                 key1: "mobile",
                                 tempText: "Mobile",
                                 cellType:.MobileTFTVCell))
        
        tablerow.append(TableRow(title:"Email Address",subTitle: email,key: "email",text:"12", key1: "noedit",tempText: "",cellType:.TextfieldTVCell))
        
        tablerow.append(TableRow(title:"Address1*",subTitle:address,text:"5", tempText: "address",cellType:.TextfieldTVCell))
    ...
    override func didTapOnCountryCodeBtnAction(cell: MobileTFTVCell) {
        country_code = cell.countryCodeTF.text ?? "+965"
    }
...
//        }
    ...
    override func didTapOnSelectedGender(cell:TextfieldTVCell){
    ...
    func callUpdateProfileAPI() {
        ...
        AF.upload(multipartFormData: { multipartFormData in
            ...
            case .success(let profileUpdateModel):
                ...
                defaults.set("\(profileUpdateModel.data?.first_name ?? "") \(profileUpdateModel.data?.last_name ?? "")", forKey: UserDefaultsKeys.username)
                
                defaults.set(profileUpdateModel.data?.image, forKey: UserDefaultsKeys.userimg)
                defaults.set(profileUpdateModel.data?.email, forKey: UserDefaultsKeys.useremail)
                defaults.set(profileUpdateModel.data?.phone, forKey: UserDefaultsKeys.usermobile)
                defaults.set(profileUpdateModel.data?.country_code, forKey: UserDefaultsKeys.usermobilecode)
