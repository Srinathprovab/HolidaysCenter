...
class HotelDetailsViewModel {
    ...
    func CALL_GET_HOTEL_DETAILS_API(dictParam: [String: Any]){
        ...
        ServiceManager.postOrPutApiCall(endPoint: ApiEndpoints.hoteldetails,parameters: parms ,resultType: HotelDetailsModel.self, p:dictParam) { sucess, result, errorMessage in
