...
class HotelMBViewModel {
    ...
    func CALL_GET_HOTEL_MOBILE_PRE_BOOKING_DETAILS_API(dictParam: [String: Any]){
        ...
        ServiceManager.postOrPutApiCall(endPoint: ApiEndpoints.mobilehotelprebooking,parameters: parms ,resultType: HotelPreBookingModel.self, p:dictParam) { sucess, result, errorMessage in
