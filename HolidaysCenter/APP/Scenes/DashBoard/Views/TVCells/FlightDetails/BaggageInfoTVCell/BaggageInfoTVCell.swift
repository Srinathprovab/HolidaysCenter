...
class BaggageInfoTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        cabinBagImg.image = UIImage(named: "b1")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
        checkInImg.image = UIImage(named: "b2")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
        sectorImg.image = UIImage(named: "flight")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
