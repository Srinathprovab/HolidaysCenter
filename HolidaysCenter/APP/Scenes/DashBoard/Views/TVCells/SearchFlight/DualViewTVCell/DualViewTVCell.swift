...
class DualViewTVCell: UITableViewCell {
    ...
    func setupUI() {
       ...
       // returnView.backgroundColor = .AppBGColor
        ...
        setupLabels(lbl: deplbl, text: "Select Date", textcolor: .AppLabelColor, font: .OpenSansRegular(size: 16))
        setupLabels(lbl: returnlbl, text: "Select Date", textcolor: .AppLabelColor, font: .OpenSansRegular(size: 16))
        self.cal1Img.image = UIImage(named: "cal")?.withRenderingMode(.alwaysOriginal)
        self.cal2img.image = UIImage(named: "cal")?.withRenderingMode(.alwaysOriginal)
        ...
        depTF.setLeftPaddingPoints(5)
        retTF.setLeftPaddingPoints(5)
