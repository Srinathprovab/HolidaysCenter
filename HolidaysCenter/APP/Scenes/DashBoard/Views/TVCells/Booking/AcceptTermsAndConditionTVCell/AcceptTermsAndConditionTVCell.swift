...
class AcceptTermsAndConditionTVCell: TableViewCell {
    ...
    func setupUI() {
        ...
        checkImg.image = UIImage(named: "uncheck")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
    ...
    func setAttributedString(str1:String,str2:String,str3:String,str4:String) {
        ...
        let atter1 = [NSAttributedString.Key.foregroundColor:UIColor.AppLabelColor,NSAttributedString.Key.font:UIFont.OpenSansRegular(size: 14)] as [NSAttributedString.Key : Any]
        let atter2 = [NSAttributedString.Key.foregroundColor:UIColor.AppBtnColor,
                      NSAttributedString.Key.font:UIFont.OpenSansRegular(size: 14),
                      NSAttributedString.Key.underlineStyle: NSUnderlineStyle.single.rawValue,
                      NSAttributedString.Key.underlineColor: UIColor.BtnTitleColor ] as [NSAttributedString.Key : Any]
    ...
    @objc func labelTapped(gesture:UITapGestureRecognizer) {
        if gesture.didTapAttributedString("T&C", in: titlelbl) {
            ...
            checkImg.image = UIImage(named: "chk")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
