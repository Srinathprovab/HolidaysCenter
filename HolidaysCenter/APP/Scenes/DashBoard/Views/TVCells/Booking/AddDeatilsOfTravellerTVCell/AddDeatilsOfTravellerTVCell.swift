...
class AddDeatilsOfTravellerTVCell: TableViewCell {
    ...
    func expandView() {
        dropdownimg.image = UIImage(named: "dropup")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
    ...
    func collapsView() {
        dropdownimg.image = UIImage(named: "down")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
    ...
    func setupFlyerDropDown() {
        flyerdropDown.textColor = .AppLabelColor
    ...
    func setupIssuingCountryDropDown() {
        dropDown1.textColor = .AppLabelColor
