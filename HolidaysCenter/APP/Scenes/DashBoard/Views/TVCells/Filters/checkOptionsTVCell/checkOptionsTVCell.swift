...
class checkOptionsTVCell: TableViewCell {
    ...
    override func updateUI() {
        ...
        if cellInfo?.key == "book" {
            ...
            sunImg.image = UIImage(named: "uncheck")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
            setAttributedString()
        }
        ...
        if cellInfo?.key == "menu" {
            ...
            sunImg.image = UIImage(named: cellInfo?.image ?? "")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor)
    ...
    func sele() {
        if let image = UIImage(named: "chk")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor) {
    ...
    func unselected() {
        if let image = UIImage(named: "uncheck")?.withRenderingMode(.alwaysOriginal).withTintColor(.AppImgColor) {
            checkImg.image = image
        } else {
            print("Image not found or nil for 'chk'")
        }
